...
import { subscriptionInputs } from "../../../formSource";
...
const NewSubscription = () => {
  ...
  const handleLocChange = (event) => {
    ...
    setSelectedLoc(selectedOptions);
  };
  ...
  const handleClick = async (e) => {
    ...
    try {
      ...
      const res = await axios.post("/subscription", newSub);
      if(res){
            ...
            <form>
              ...
              <div className="formInput">
                ...
                <select
                  ...
                  value={selectedLoc} // This is important for controlled components
                >
